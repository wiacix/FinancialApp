...
const SelectAccount = (props) => {
    ...
    <View style={{ width: '100%', justifyContent: 'center', alignItems: 'center' }}>
        ...
        <View style={{width: '90%', backgroundColor: '#414449', marginBottom: 15, borderRadius: 10}} key={row.Id}>
            <Pressable onPress={() => changeAccount(row.Code)} style={{justifyContent: 'center', alignItems: 'center', flexDirection: 'row', justifyContent: 'space-between', paddingHorizontal: 20, paddingVertical: 5}}>
                <View style={{ flexDirection: 'row', alignItems: 'center'}}>
                ...
                <View style={{alignItems: 'center', flexDirection: 'row'}}>
                    ...
                    <Text style={{fontSize: 14, color: 'white', marginLeft: 10}}>{row.Balance.toFixed(2)} PLN</Text>
                </View>
            </Pressable>
        </View> 
        )})}
